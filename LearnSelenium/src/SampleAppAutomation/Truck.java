...
public class Truck {
	...
	public static void main(String[] args) {
		...
		//Select truck in main window
		dr.findElement(By.xpath("//a[@id='nav_truck'][@name='Navigation Truck'][text()='Truck']")).click();
		...
		dr.findElement(By.xpath("//input[@id='payload']")).sendKeys("1	000");
		
		dr.findElement(By.xpath("//input[@id='totalweight']")).sendKeys("4000");
