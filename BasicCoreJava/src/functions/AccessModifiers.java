...
public class AccessModifiers {
	...
	//protected - Can be accessed within the package, or throughout the project using child class
		...
		//eclipse resolves the import class issues automatically
		//but there comes a time when we have two classes with the same name
		//then we have to resolve the import conflict by ourselves
